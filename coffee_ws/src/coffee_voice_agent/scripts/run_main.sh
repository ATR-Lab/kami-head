#!/bin/bash
# Coffee Voice Agent Launcher - Refactored Version (Console Mode)
# 
...
# - Better file organization (StateManager, CoffeeBaristaAgent separated)
...
show_banner() {
    echo
    echo "╔════════════════════════════════════════════════════════════════╗"
    echo "║               Coffee Voice Agent Launcher (Refactored)        ║"
    echo "║                        ${VOICE_AGENT_MODE^} Mode                            ║"
    echo "╠════════════════════════════════════════════════════════════════╣"
    echo "║  🏗️  Architecture: Modular (StateManager + CoffeeBaristaAgent) ║"
    ...
    echo "║  Wake Word: Say 'hey barista' to activate voice interaction   ║"
    echo "╚════════════════════════════════════════════════════════════════╝"
    echo
}
...
cleanup() {
    print_info "Shutting down refactored voice agent..."
...
# Main execution
main() {
    print_info "Starting Coffee Voice Agent (Refactored Version)..."
    ...
    print_info "Launching refactored voice agent in $VOICE_AGENT_MODE mode..."
